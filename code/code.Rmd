...
# Full Model
nflx_model <- lm(`Netflix Daily Change` ~ `Netflix Sentiment Score` + `NASDAQ Daily Change` + `Interest Rate` + `Unemployment Rate` + `Netflix Volume` + Month + Year + Inflation, data = nflx_cleaned)
summary(nflx_model)
...
# Full Model
amzn_model <- lm(`Amazon Daily Change` ~ `Amazon Sentiment Score` + `NASDAQ Daily Change` + `Interest Rate` + `Amazon Volume`+ `Unemployment Rate` + Month + Year, data = amzn_cleaned)
summary(amzn_model)
...
# Full Model
meta_model <- lm(`Meta Daily Change` ~ `Meta Sentiment Score` + `NASDAQ Daily Change` + `Interest Rate` + `Meta Volume` + `Unemployment Rate` + + Month + Year, data = meta_cleaned)
summary(meta_model) 
